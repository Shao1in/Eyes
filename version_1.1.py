...
cv2.createTrackbar('index', 'settings', 1, 4, nothing)
cv2.createTrackbar('layer', 'settings', 1, 7, nothing)

crange = [0,0,0, 0,0,0]

fn = 'image_2.jpg' # путь к файлу с картинкой
...
while True:
    ...
    cv2.drawContours(img, contours, index, (255, 0, 0), 3, cv2.LINE_AA, hierarchy, layer)
